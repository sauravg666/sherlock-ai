...
This file is the public release history for Sherlock. Keep entries user-facing: what changed, why it matters, and anything users should do after upgrading.
...
- Restricted `.sherlock-ai/web-search.json` permissions to user-only (`0600`) after Sherlock writes web-search provider configuration.
