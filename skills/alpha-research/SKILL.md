...
Run `alpha login` to authenticate with alphaXiv. Check status with `sherlock-ai alpha status`, or `alpha status` once your installed `alpha-hub` version includes it.
