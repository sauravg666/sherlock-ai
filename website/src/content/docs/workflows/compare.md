...
```bash
sherlock-ai compare "topic or list of sources"
```

You can provide a topic and let Sherlock find the sources, or list specific papers and documents for a targeted comparison.
